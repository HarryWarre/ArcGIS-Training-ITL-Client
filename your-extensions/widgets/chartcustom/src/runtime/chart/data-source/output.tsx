import { DataSourceComponent, Immutable, type ImmutableObject, React, type UseDataSource, DataSourceStatus, type FeatureLayerDataSource, type SceneLayerDataSource, DataSourceManager, dataSourceUtils, hooks, getAppStore, lodash } from 'jimu-core'
...
const OutputSourceManager = (props: OutputSourceManagerProps) => {
  ...
  const syncOriginDsInfo = (outputDataSource: FeatureLayerDataSource | SceneLayerDataSource) => {
    ...
    outputDataSource.setLayerDefinition(dataSourceUtils.getLayerDefinitionIntersection(originDs.getLayerDefinition(), outputDataSource))
  }
